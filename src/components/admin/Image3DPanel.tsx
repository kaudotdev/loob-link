            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-900 border border-[var(--admin-border)] rounded p-4 space-y-2">
                ...
                <ul className="text-xs text-gray-400 font-mono space-y-1">
                  <li>• <span className="text-white">Botão esquerdo</span> do mouse para rotacionar o objeto</li>
                  <li>• <span className="text-white">Botão direito</span> do mouse para mover o objeto</li>
